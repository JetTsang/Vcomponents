...
```
git clone git@github.com:JetTsang/Vcomponents.git
...
import "v-components/lib/style/index.css";
Vue.use(VComponents)

按需引入:
import { CheckIn, watermark } from "v-components";
import "v-components/lib/style/index.css";
...
```
import { Magnifier } from 'v-components';
Vue.use(Magnifier)
```
...
```
import { CheckIn } from 'v-components';
Vue.use(CheckIn)
```
...
```
import { ImgLabel } from 'v-components';
Vue.use(ImgLabel)
```
...
```
import { SlideCheck } from 'v-components';
Vue.use(SlideCheck)
```
...
```
import { Countdown } from 'v-components';
Vue.use(Countdown)
```
...
```
import { watermark } from 'v-components';
Vue.use(watermark)
```
...
```
import { DragWrap, DragItem } from 'v-components';
...
```
import { FindDiff } from 'v-components';
Vue.use(FindDiff)
```
